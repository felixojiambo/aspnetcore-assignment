...
namespace Queue_Management_System.Data
{
    public class TicketRepository
    {
        ...
        public TicketRepository(IConfiguration configuration, IHubContext<QueueHub> hubContext)
        {
            _connectionString = configuration.GetConnectionString("QueueManagementSystem");
        ...
        public void CreateTicket(Ticket ticket)
        {
            ...
            _hubContext.Clients.All.SendAsync("ReceiveTicketUpdate", ticket.Id.ToString(), ticket.ServicePointId.ToString());
        }
        ...
        public void DeleteTicket(int id)
        {
            ...
            // Trigger an update to all connected clients
            _hubContext.Clients.All.SendAsync("ReceiveTicketUpdate", id.ToString(), "");
        }

        // Add other methods as needed, similar to the UserService methods
    }
}
